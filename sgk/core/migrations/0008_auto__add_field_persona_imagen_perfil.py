...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.imagen_perfil'
        db.add_column(u'core_persona', 'imagen_perfil',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.imagen_perfil'
        db.delete_column(u'core_persona', 'imagen_perfil')
