...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profesional.usuario'
        db.alter_column(u'core_profesional', 'usuario_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Profesional', fields ['usuario']
        db.create_unique(u'core_profesional', ['usuario_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profesional', fields ['usuario']
        db.delete_unique(u'core_profesional', ['usuario_id'])


        # Changing field 'Profesional.usuario'
        db.alter_column(u'core_profesional', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
