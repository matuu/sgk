...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Paciente.antecedente'
        db.alter_column(u'core_paciente', 'antecedente_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Antecedente'], unique=True))
        # Adding unique constraint on 'Paciente', fields ['antecedente']
        db.create_unique(u'core_paciente', ['antecedente_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Paciente', fields ['antecedente']
        db.delete_unique(u'core_paciente', ['antecedente_id'])


        # Changing field 'Paciente.antecedente'
        db.alter_column(u'core_paciente', 'antecedente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Antecedente']))
