...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Turno.dia'
        db.alter_column(u'core_turno', 'dia', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Turno.dia'
        db.alter_column(u'core_turno', 'dia', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
