...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MotivoConsulta.motivo_consulta_paciente'
        db.add_column(u'core_motivoconsulta', 'motivo_consulta_paciente',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


        # Changing field 'Persona.estado_civil'
        db.alter_column(u'core_persona', 'estado_civil', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):
        # Deleting field 'MotivoConsulta.motivo_consulta_paciente'
        db.delete_column(u'core_motivoconsulta', 'motivo_consulta_paciente')


        # Changing field 'Persona.estado_civil'
        db.alter_column(u'core_persona', 'estado_civil', self.gf('django.db.models.fields.CharField')(max_length=255))
