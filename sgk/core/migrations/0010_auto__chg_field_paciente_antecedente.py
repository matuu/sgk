...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_paciente', 'antecedente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Antecedente']))

    def backwards(self, orm):

        # Changing field 'Paciente.antecedente'
        db.alter_column(u'core_paciente', 'antecedente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Antecedente'], null=True))
    ...
    models = {
        ...
        u'core.paciente': {
            ...
            'antecedente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Antecedente']"}),
            'creado_el': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
