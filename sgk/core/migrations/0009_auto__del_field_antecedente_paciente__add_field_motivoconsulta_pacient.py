...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Antecedente.paciente'
        db.delete_column(u'core_antecedente', 'paciente_id')

        # Adding field 'MotivoConsulta.paciente'
        db.add_column(u'core_motivoconsulta', 'paciente',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Paciente']),
                      keep_default=False)

        # Adding field 'Paciente.antecedente'
        db.add_column(u'core_paciente', 'antecedente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Antecedente'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Antecedente.paciente'
        db.add_column(u'core_antecedente', 'paciente',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Paciente']),
                      keep_default=False)

        # Deleting field 'MotivoConsulta.paciente'
        db.delete_column(u'core_motivoconsulta', 'paciente_id')

        # Deleting field 'Paciente.antecedente'
        db.delete_column(u'core_paciente', 'antecedente_id')
    ...
    models = {
        ...
        u'core.paciente': {
            ...
            'antecedente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Antecedente']", 'null': 'True'}),
            'creado_el': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
