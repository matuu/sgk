    ...
    def get_model(self):
        if self.model:
            ...
            try:
                ...
                raise ImproperlyConfigured("No model to create "
                                           "the modelformset. Provide one.")
...
class FormSetsMixin(object):
    ...
    def construct_formsets(self):
        ...
        prefixes = {}
        print "---->", self.enhanced_formsets_instances
...
class ModelFormSetsMixin(FormSetsMixin):
    ...
    def get_formsets_kwargs(self, enhanced_formset):
        ...
        """
        kwargs = super(ModelFormSetsMixin,
                       self).get_formsets_kwargs(enhanced_formset)
        kwargs.update({
...
class InlineFormSetsMixin(ModelFormSetsMixin, ModelFormMixin):
    ...
    def get_formsets_kwargs(self, enhanced_formset):
        ...
        """
        kwargs = super(InlineFormSetsMixin,
                       self).get_formsets_kwargs(enhanced_formset)
        kwargs.update({
